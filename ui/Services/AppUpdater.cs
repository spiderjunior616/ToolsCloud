...
{
    private const string RepoOwner = "spiderjunior616";
    private const string RepoName = "ToolsCloud";
    ...
    static AppUpdater()
    {
        Http.DefaultRequestHeaders.UserAgent.ParseAdd("ToolsCloud-AutoUpdate");
    }
    ...
    {
        var tempPath = Path.Combine(Path.GetTempPath(), $"ToolsCloud_{Guid.NewGuid():N}.exe");
        try
        {
